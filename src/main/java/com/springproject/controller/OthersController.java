...
public class OthersController {
    ...
    public String deleteReply2(@PathVariable("commentId") Long commentId, @RequestParam("otherMember")String userid) {
        Long boardId = commentService.findBoardIdByCommentId(commentId);
        commentService.deleteComment(commentId);
        return "redirect:/otherblogpost/" + boardId +"?otherMember="+userid;
    }
}